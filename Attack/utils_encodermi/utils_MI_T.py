...
def our_attack_save_train(model):
    ...
    if not os.path.exists('./dump/'):
        os.mkdir('./dump/')
    np.savez('./dump/MI_threshold_based_train_data.npz', attack_train_data, attack_train_label)
...
def our_attack_save_test(model):
    ...
    if not os.path.exists('./dump/'):
        os.mkdir('./dump/')
    np.savez('./dump/MI_threshold_based_test_data.npz', attack_test_data, attack_test_label)